    ...
    <div class="min-h-screen bg-gray-50 py-8">
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-white shadow-sm rounded-lg p-6 mb-6">
                <h1 class="text-2xl font-bold text-gray-900 mb-2">Student Evaluation of Teachers (SET)</h1>
                <div class="text-sm text-gray-600 space-y-1">
                    <p><strong>Instructor:</strong> {{ $instructor->name ?? 'N/A' }}</p>
                    <p><strong>Course:</strong> {{ $sectionStudent->section->course->course_name ?? 'N/A' }}</p>
                    <p><strong>Section:</strong> {{ $sectionStudent->section->section_label ?? 'N/A' }}</p>
            ...
            <form id="evaluationForm" action="{{ route('student.evaluation.store', $sectionStudent->id) }}" method="POST">
                ...
                <div class="bg-white shadow-sm rounded-lg p-6 mb-6">
                    <h2 class="text-xl font-bold text-gray-900 mb-2">A. Management of Teaching and Learning</h2>
                    <p class="text-sm text-gray-600 mb-4 italic">Management of Teaching and Learning refers to the
                        intentional and organized handling of classroom presence, clear communication of academic
                        expectations, efficient use of time, and the purposeful use of student-centered activities.</p>

                    @php
$sectionA = [
    'a1' => 'Comes to class on time',
    ...
    'a6' => 'Communicates constructive feedback to students for their academic growth.'
                ...
                <div class="bg-white shadow-sm rounded-lg p-6 mb-6">
                    <h2 class="text-xl font-bold text-gray-900 mb-2">B. Content Knowledge, Pedagogy and Technology</h2>
                    <p class="text-sm text-gray-600 mb-4 italic">Content Knowledge, Pedagogy, and Technology refer to a
                        teacher's ability to demonstrate a strong grasp of subject matter, present complex concepts in a
                        clear and accessible way.</p>
...
$sectionB = [
    ...
    'b12' => 'Demonstrates effective classroom management and creates a conducive learning environment'
                ...
                <div class="bg-white shadow-sm rounded-lg p-6 mb-6">
                    <h2 class="text-xl font-bold text-gray-900 mb-2">C. Commitment and Transparency</h2>
                    <p class="text-sm text-gray-600 mb-4 italic">Commitment and Transparency refer to the teacher's
                        consistent dedication to supporting student learning by acknowledging learner diversity.</p>
